...
export default async function AmmoPage({ params }: Props) {
  ...
  try {
    ...
    return <section className="mx-auto max-w-content px-4 py-8 sm:px-6"><ToolIntro title={t('title')} description={t('description')} sourceLabel={t('source')} /><AmmoChart regular={{ ...regular, armor: [] }} pve={{ ...pve, armor: [] }} /></section>;
  } catch {
