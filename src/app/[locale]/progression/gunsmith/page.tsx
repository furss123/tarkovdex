...
export default async function GunsmithPage({ params }: Props) {
  ...
  try {
    ...
    return <section className="mx-auto max-w-content px-4 py-8 sm:px-6"><ToolIntro title={t('title')} description={t('description')} updatedAt={null} sourceLabel={t('source')} locale={locale} /><GunsmithExplorer regular={regular} pve={pve} /></section>;
  } catch {
