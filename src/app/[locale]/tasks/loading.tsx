  ...
  return (
    <section className="mx-auto max-w-content px-4 py-10 sm:px-6">
      ...
      <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        {/* Two w-32 bars side by side are 2x12rem + gap = wider than a 375px
            phone under the 1.5x spacing scale, so they share the row on
            mobile and only take their fixed width from sm up. */}
